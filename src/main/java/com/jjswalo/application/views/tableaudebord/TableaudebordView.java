package com.jjswalo.application.views.tableaudebord;


import com.jjswalo.application.views.MainLayout;
import com.jjswalo.application.views.tableaudebord.ServiceHealth.Status;
...
@AnonymousAllowed
public class TableaudebordView extends Main {

    public TableaudebordView() {
        addClassName("tableaudebord-view");
